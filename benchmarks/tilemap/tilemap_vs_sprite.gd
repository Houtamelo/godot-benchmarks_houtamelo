...
var tilemap_scene: PackedScene = preload("res://benchmarks/tilemap/scene_tilemap.tscn")
var single_sprites: Array[PackedScene] = [
    preload("res://benchmarks/tilemap/scene_single_node_0.tscn"),
    preload("res://benchmarks/tilemap/scene_single_node_1.tscn"),
    preload("res://benchmarks/tilemap/scene_single_node_2.tscn"),
    preload("res://benchmarks/tilemap/scene_single_node_3.tscn"),
    preload("res://benchmarks/tilemap/scene_single_node_4.tscn"),
    preload("res://benchmarks/tilemap/scene_single_node_5.tscn"),
    preload("res://benchmarks/tilemap/scene_single_node_6.tscn"),
    preload("res://benchmarks/tilemap/scene_single_node_7.tscn"),
]
